...
<php lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="../admin/assets/css/fancybox.min.css">
        <link rel="stylesheet" href="../admin/assets/css/selectize.min.css">
        <link rel="stylesheet" href="../admin/assets/css/metismenu.min.css">
        <link rel="stylesheet" href="../admin/assets/css/simplebar.min.css">
    ...
    <body>
        ...
        <div class="sidemenu-area">
            <div class="sidemenu-header">
                <a href="candidates-dashboard.php" class="navbar-brand d-flex align-items-center">
                <img src="../admin/assets/images/bgimg.png" class="black-logo" alt="image" height="150px" width="120px">
            ...
            <div class="sidemenu-body">
                <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
                    ...
                    <li class="nav-item">
                        <a href="candidates-dashboard-applied-job.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="candidates-dashboard-job-alerts.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="candidates-dashboard-shortlisted-job.php" class="nav-link">
                    ...
                    <!-- <li class="nav-item">
                        <a href="candidates-dashboard-cv-manager.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="dashboard-messages.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="dashboard-my-profile.php" class="nav-link">
                            <span class="icon"><i class="ri-user-line"></i></span>
                                    ...
                                    <div class="dropdown profile-nav-item">
                                        <a href="#" class="dropdown-bs-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <div class="menu-profile">
                                                <img src="../admin/assets/images/dashboard/user1.jpg" class="rounded-circle" alt="image">
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="dropdown-header d-flex flex-column align-items-center">
                                                ...
                                                <div class="info text-center">
                                                    ...
                                                    <p class="mb-3 email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1e767b7272715e7f707a6c716d73776a76307d7173">[email&#160;protected]</a></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown-body">
                                                <ul class="profile-nav p-0 pt-3">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="candidates-dashboard-submit-resume.php" class="nav-link">
                                                            <span class="icon"><i class="ri-bookmark-line"></i></span>
                                            ...
                                            <div class="dropdown-footer">
                                                <ul class="profile-nav">
                                                    <li class="nav-item">
                                                        <a href="index.php" class="nav-link"><i class="ri-logout-box-r-line"></i> <span>Logout</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
