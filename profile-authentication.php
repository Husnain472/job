<?php include'inc/header.php'?>
                ...
                <div class="profile-authentication-tabs">
                    <div class="authentication-tabs-list">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link " id="login-tab" data-bs-toggle="tab" href="#login" role="tab" aria-controls="login">Login</a>
                            </li>
    
                            <li class="nav-item">
                                <a class="nav-link active" id="register-tab" data-bs-toggle="tab" href="#register" role="tab" aria-controls="register">Register</a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show " id="login" role="tabpanel">
    ...
    <button type="submit" class="default-btn">Log In <i class="flaticon-send"></i></button>
                        ...
                        <div class="tab-pane show active" id="register" role="tabpanel">
                            <div class="eeza-authentication-form">
